...
struct Wind : public Component
{
	...
	SetPerObjectGroupConstantsShaderAction::hlsl_Wind m_cbuffer; // gpu mirror : values that will be set into gpu registers vi shader action hlsl_cbPerObjectGroup_c1
};
