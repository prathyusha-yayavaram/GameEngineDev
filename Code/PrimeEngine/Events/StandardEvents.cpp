...
namespace Events {
	...
	PE_IMPLEMENT_CLASS1(Event_MOUSE_CLICK, Event);
	PE_IMPLEMENT_CLASS1(Event_NAVMESH_PROP2, Event);
	PE_IMPLEMENT_CLASS1(Event_NAVMESH_PROP3, Event);
	//PE_IMPLEMENT_CLASS1(PathFindingEngine_Event_PATH_POSITIONS_FOUND, Event);
	PE_IMPLEMENT_CLASS1(Event_FIND_PATH, Event);
