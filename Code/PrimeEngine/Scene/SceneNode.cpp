...
// Constructor -------------------------------------------------------------
SceneNode::SceneNode(PE::GameContext &context, PE::MemoryArena arena, Handle hMyself) :  Component(context, arena, hMyself), m_lights(context, arena, 8), m_winds(context, arena, 8), m_inheritPositionOnly(false)
{
}
