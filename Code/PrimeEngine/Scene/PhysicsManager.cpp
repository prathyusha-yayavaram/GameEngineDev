...
namespace PE {
	namespace Components {
		...
		PE_IMPLEMENT_CLASS1(PhysicsManager, SceneNode);
		...
		void PhysicsManager::addDefaultComponents()
		{
			...
			PE_REGISTER_EVENT_HANDLER(Events::Event_GATHER_DRAWCALLS, PhysicsManager::do_GATHER_DRAWCALLS);
			PE_REGISTER_EVENT_HANDLER(Events::Event_GATHER_DRAWCALLS_Z_ONLY, PhysicsManager::do_GATHER_DRAWCALLS);
		}

		void PhysicsManager::do_GATHER_DRAWCALLS(Events::Event* pEvt)
		{
			...
			SceneNode* pRoot = PhysicsManager::Instance();
